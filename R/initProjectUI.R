      ...
      miniTabPanel(
        ...
        miniContentPanel(
          ...
          fluidRow(
            column(
              width = 6,
              tags$h4("Basic shiny script :", class = "addInit-label"),
              br(),
              # shinyWidgets::pickerInput(
              #   inputId = "config_path_shiny", label = "Where :", 
              #   choices = c(". (root)" = ".", list_dirs(recursive = FALSE)), selected = ".",
              #   options = list(size = 5)
              # ),
              # shinyWidgets::awesomeRadio(
              ...
              # ),
              fluidRow(
                column(6, shinyWidgets::materialSwitch(inputId = "ui", label = "ui.R", value = params$shiny$ui, status = "warning", right = TRUE)),
                column(6, shinyWidgets::materialSwitch(inputId = "server", label = "server.R", value = params$shiny$server, status = "warning", right = TRUE))
              ),
              
              fluidRow(
                column(6, shinyWidgets::materialSwitch(inputId = "global", label = "global.R", value = params$shiny$global, status = "warning", right = TRUE))
              ),
            ...
            column(
              ...
              column(
                ...
                tags$div(
                  ...
                  tags$h4("Other scripts :", class = "addInit-label"),
                  shinyWidgets::pickerInput(
                    inputId = "path_other_shiny", label = "Where :", 
                    choices = c(". (root)" = ".", list_dirs(recursive = FALSE)), selected = ".",
                    options = list(size = 5)
                  )
                )
          ...
          fluidRow(
            column(
              ...
              tags$div(
                style = "float:right",
                actionButton(inputId = "config_create_shiny", label = "Create !", icon = icon("cog"), class = "btn-primary")
              )
            ),
            column(
              width = 6,
